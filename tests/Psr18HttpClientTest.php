...
namespace Escorp\LemanaProApiClient\Tests;
...
final class Psr18HttpClientTest extends TestCase
{
    ...
    public function it_throws_exception_on_invalid_json(): void
    {
        ...
        $this->expectException(LemanaProApiClientException::class);
    ...
    public function it_throws_wb_http_exception_on_json_error_response(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf(LemanaProErrorDto::class, $e->getError());
            $this->assertSame(401, $e->getError()->code);
        }
    }
